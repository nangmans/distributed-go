...
import (
	...
	"github.com/nangmans14/proglog/internal/auth"
	"github.com/nangmans14/proglog/internal/config"
	"github.com/nangmans14/proglog/internal/log"
...
func setupTest(t *testing.T, fn func(*Config)) (client, _ api.LogClient, cfg *Config, teardown func()) {
	t.Helper()
